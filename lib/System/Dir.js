...
var promiseSomeSerial = require('../util/promiseSomeSerial.js');
...
var readDirAndStat = function(dirSystemPath) {
  return fs.readdir(dirSystemPath).catch(
    // A missing directory is the same as an empty directory.
    handleError(
